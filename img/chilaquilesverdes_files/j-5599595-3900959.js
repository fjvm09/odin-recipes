//Generated:2022-05-05 20:42:49// 6-254
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5599595 || '',
    guid: window.ftGUID_5599595 || '',
    confID: window.ftConfID_5599595 || '0',
    ftReturn: window.ftReturn_5599595 || '',
    keyword: window.ftKeyword_5599595 || '',
    ftId: window.ftId_5599595 || '',
    ftImpId: window.ftImp5599595 && window.ftImp5599595.impID || '',
    gdpr: window.ftImp5599595 && window.ftImp5599595.gdpr || '',
    gdpr_consent: window.ftImp5599595 && window.ftImp5599595.gdpr_consent || '',
    gdpr_pd: window.ftImp5599595 && window.ftImp5599595.gdpr_pd || '',
    us_privacy: window.ftImp5599595 && window.ftImp5599595.us_privacy || '',
    campaignID: '115845',
    cID: '155979',
    pID: '5599595',
    creativeID: '3900959',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115845&sid=18300&plc=5599595&num=&adid=&advid=&adsrv=29&btreg=5599595&btadsrv=flashtalking&crt=3900959&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115845;5599595;3900959;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/de/creativecloud/plans.html?plan=individual&locale=de?sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?222299858-5599595;3900959;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/559/5599595/3900959/image/3900959.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115845;5599595;202;pixel;Verizon;VerizonFY20CCLALFreePredictiveSegmentHighDEDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115845;5599595;3900959;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/de/creativecloud/plans.html?plan=individual&locale=de?sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv5599595',
    altimgID: 'ftalt5599595',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5599595 && parseInt(window.ftImp5599595.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5599595') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5599595'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_5599595").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_5599595").style.display = "none";
		    }
		});
	}
}(ft5599595));
...
(function(o) {
    o.addEventListener("obaEnd", function(){
        try {
            document.getElementById("ftAdChoices_5599595").style.zIndex = "99";
        } catch(e){
            console.log("ftAdChoices not found");
        }
    });
}(ft5599595));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115845&l2=Verizon&l3=5599595&l4=3900959&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115845&l2=Verizon&l3=5599595&l4=3900959&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_5599595;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_5599595;
