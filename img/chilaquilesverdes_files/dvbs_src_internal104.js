...
function dv_handler152(){function L(b){var d=window._dv_win,f=0;try{for(;10>f;){if(d[b]&&"object"===typeof d[b])return!0;if(d==d.parent)break;f++;d=d.parent}}catch(c){}return!1}function E(b,d,f){f=f||150;var c=window._dv_win||window;if(c.document&&c.document.body)return d&&d.parentNode?d.parentNode.insertBefore(b,d):c.document.body.insertBefore(b,c.document.body.firstChild),!0;if(0<f)setTimeout(function(){E(b,d,--f)},20);else return!1}function M(b){var d=window._dv_win.dv_config=window._dv_win.dv_config||
{};d.cdnAddress=d.cdnAddress||"cdn.doubleverify.com";return'<html><head><script type="text/javascript">('+function(){try{window.$dv=window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(f){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+(b||"function() {}")+')("'+d.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function F(b){var d=0,f;for(f in b)b.hasOwnProperty(f)&&++d;return d}
function N(b,d){a:{var f={};try{if(b&&b.performance&&b.performance.getEntries){var c=b.performance.getEntries();for(b=0;b<c.length;b++){var e=c[b],p=e.name.match(/.*\/(.+?)\./);if(p&&p[1]){var g=p[1].replace(/\d+$/,""),h=d[g];if(h){for(var k=0;k<h.stats.length;k++){var r=h.stats[k];f[h.prefix+r.prefix]=Math.round(e[r.name])}delete d[g];if(!F(d))break}}}}var l=f;break a}catch(y){}l=void 0}if(l&&F(l))return l}function O(b,d){function f(b){var c=k,e;for(e in b)b.hasOwnProperty(e)&&(c+=["&"+e,"="+b[e]].join(""));
return c}function c(){return Date.now?Date.now():(new Date).getTime()}function e(){var e=f({dvp_injd:1});$dvbs.domUtilities.addImage(e,document.body);e="https://cdn.doubleverify.com/dvtp_src.js#tagtype=video";var d="ctx cmp plc sid adsrv adid crt advid prr dup turl iframe ad vssd apifw vstvr tvcp ppid auip pltfrm gdpr gdpr_consent adu invs litm ord sadv scrt vidreg seltag splc spos sup unit dvtagver msrapi vfwctx auprice audeal auevent auadv aucmp aucrtv auorder ausite auplc auxch audvc aulitem auadid autt c1 c2 c3 c4 c5 c6 c7 c8 c9 c10 c11 c12 c13 c14 c15 aufilter1 aufilter2 ppid".split(" ");
for(i=0;i<d.length;i++){var p=d[i],g=b[p];void 0!==g&&(e+=["&",p,"=",encodeURIComponent(g)].join(""))}e+="&gmnpo="+("1"==b.gmnpo?"1":"0");e+="&dvp_dvtpts="+c();e+="&bsimpid="+h;void 0!==b.dvp_aubndl&&(e+="&aubndl="+encodeURIComponent(b.dvp_aubndl));for(var l in b)b.hasOwnProperty(l)&&l.match(/^dvpx?_/i)&&b[l]&&(e+=["&",l.toLocaleLowerCase(),"=",encodeURIComponent(b[l])].join(""));$dvbs.domUtilities.addScriptResource(e,document.body)}function p(b){var e={};e[b]=c();b=f(e);$dvbs.domUtilities.addImage(b,
document.body)}function g(b,e){-1<H.indexOf(b)?p(e):w.subscribe(function(){p(e)},b)}var h=b.impressionId,k=window._dv_win.dv_config.bsEventJSURL?window._dv_win.dv_config.bsEventJSURL:"https://"+b.ServerPublicDns+"/bsevent.gif";k+="?impid="+encodeURIComponent(h);var r=f({dvp_innovidImp:1}),l="responseReceived_"+h,y=b.DVP_DCB,v=b.adid;switch(d.ResultID){case 5:var n=1;break;case 6:n=2;break;default:n=d.ResultID}console.log("originalResultID",n);$dvbs.domUtilities.addImage(r,document.body);if("function"===
typeof window[y]){var q=!1;setTimeout(function(){var b=f({dvp_wasCallbackCalled:q});$dvbs.domUtilities.addImage(b,document.body)},1E3);window[l]=function(b,e,d,p,g,l,h){q=!0;try{if(h){var k=f({dvp_stat:h});$dvbs.domUtilities.addImage(k,document.body)}else{k=f({dvp_r9:c()});$dvbs.domUtilities.addImage(k,document.body);b="&dvp_cStartTS="+d+"&dvp_cEndTS="+p+"&dvp_dReceivedTS="+g+"&dvp_wasAdPlayed="+b;d=n;if(!e)switch(d=2,n){case 1:var m=21;break;case 2:m=20;break;case 3:m=22;break;case 4:m=23}k=f({bres:d,
breason:m,dvp_blkDecUsed:e?"1":"0"})+b;$dvbs.domUtilities.addImage(k,document.body,l)}}catch(P){e=f({dvp_innovidCallbackEx:1,dvp_innovidCallbackExMsg:P}),$dvbs.domUtilities.addImage(e,document.body)}};try{var A=f({dvp_r8:c()});$dvbs.domUtilities.addImage(A,document.body);window[y](n,l)}catch(t){d=f({dvp_innovidEx:1,dvp_innovidExMsg:t}),$dvbs.domUtilities.addImage(d,document.body)}}else d=f({dvp_innovidNoCallback:1}),$dvbs.domUtilities.addImage(d,document.body);try{var w=window[v]();if(w.getPreviousEvents&&
"function"===typeof w.getPreviousEvents){var H=w.getPreviousEvents();-1<H.indexOf("AdStarted")?e():w.subscribe(e,"AdStarted");g("AdError","dvp_ader");g("AdStopped","dvp_adst");g("AdVideoStart","dvp_avse");g("AdImpression","dvp_aie")}else{var u=f({dvp_innovidCallbackEx:3,dvp_innovidCallbackExMsg:"vpaidWrapper.getPreviousEvents not a function"});$dvbs.domUtilities.addImage(u,document.body)}}catch(t){u=f({dvp_innovidCallbackEx:2,dvp_innovidCallbackExMsg:t}),$dvbs.domUtilities.addImage(u,document.body)}}
function R(b){var d,f=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(c){var e=window._dv_win.$dvbs;e&&(d=c.ImpressionID,e.tags.add(c.ImpressionID,b),e.tags[c.ImpressionID].set({tagElement:b.script,impressionId:c.ImpressionID,dv_protocol:b.protocol,protocol:"https:",uid:b.uid,serverPublicDns:c.ServerPublicDns,ServerPublicDns:c.ServerPublicDns}),b.script&&b.script.dvFrmWin&&(b.script.dvFrmWin.$uid=c.ImpressionID,e.messages&&e.messages.startSendingEvents&&e.messages.startSendingEvents(b.script.dvFrmWin,
c.ImpressionID)),function(){function b(){var d=window._dv_win.document.visibilityState;"prerender"===f&&"prerender"!==d&&"unloaded"!==d&&(f=d,window._dv_win.$dvbs.registerEventCall(c.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(e,b))}if("prerender"===f)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbs.registerEventCall(c.ImpressionID,{prndr:0});else{var e;"undefined"!==typeof window._dv_win.document.hidden?e="visibilitychange":
"undefined"!==typeof window._dv_win.document.mozHidden?e="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?e="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(e="webkitvisibilitychange");window._dv_win.document.addEventListener(e,b,!1)}}());if("1"!=b.foie)try{var p=N(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});p&&window._dv_win.$dvbs.registerEventCall(c.ImpressionID,p)}catch(g){}};window[b.callbackName]=function(c){u.setIsJSONPCalled(!0);
var e=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[d]?window._dv_win.$dvbs.tags[d]:b;var f=window._dv_win.dv_config.bs_renderingMethod||function(b){document.write(b)};"video"===e.tagtype&&void 0!==e.adid&&setTimeout(function(){O(e,c)},0);switch(c.ResultID){case 1:e.tagPassback?f(e.tagPassback):c.Passback?f(decodeURIComponent(c.Passback)):c.AdWidth&&c.AdHeight&&f(decodeURIComponent("%3Cdiv%20style%3D%22display%3A%20flex%3B%20align-items%3A%20center%3B%20justify-content%3A%20center%3B%20width%3A%20"+
c.AdWidth+"px%3B%20height%3A%20"+c.AdHeight+"px%3B%20outline-offset%3A%20-1px%3B%20background%3A%20url('data%3Aimage%2Fpng%3Bbase64%2CiVBORw0KGgoAAAANSUhEUgAAADoAAAA6CAYAAAGWvHq%2BAAAABmJLR0QA%2FwD%2FAP%2BgvaeTAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAB3RJTUUH5AQBECEbFuFN7gAAAB1pVFh0Q29tbWVudAAAAAAAQ3JlYXRlZCB3aXRoIEdJTVBkLmUHAAAFBklEQVRo3uUby3arOEzxAbxIyKLt%2F%2F9gIQtIF4aFZ5ERVxhJyIbcnjmjTZLast4vQ%2BG762OMMX53fQzTFIfxGenfKvgXvj4%2FoOsfy3eECgBgmmcYhnFZ6PoHeO%2F%2FbBiGEQAAxufPghlC%2BLOBYqa%2FHezAJcYYOUz87QAA7vd2g4lMAsrLfQJ%2BQeUM43PZsMJEwN8L58gMfgIAAMVKv6syX4bxGVF9qTiuvV2Byouf7e0Kl%2B%2Buj6kJU8aktV07aFClTkThfm9hGMbNGu53dCNd%2FPr8gBCm5TsnAivz%2BPwBqkHvPaDiVvpAW6Nh0FBhmpagSdfQV0Q7oVySPrz3LyO3t%2BvCKrJIHTtdG58%2FvLycZk%2Bzr1uFkgFWuYHKZHHNEMIr4lMb0pO5v7e3qyyj983KATYydv1jswFZneZ5wzaKVaEMVnNgjsw2B8pcbMdLmKbY1PVG5dTl0rVpnsGlSDReOcfo%2Bgc0df3SagrTPC8m4aDrH1ClaR4AgHKRmgN%2FL9HBbeI4wdKVitXUtYpLGXPSgpUg1lBaPzWCWW6wJ4lkB9aFUL1pQkXOvW9WBDltULNM8wwhTEtIcQn88t31kdpEU7FmOwsemqiiqtPsQvufXMCmCulUSKy9XaG9XYGrLhbv1iSlWU0NGdyQqlPKBHQfh0vxVkQ1abSQybX3oQ7nUPWUpEQ1oaokLVAnSfG4cy8xxpjrEFyVtuCJNt3rETDgu%2F6xiT9zRqKSci0DxzHdZ5E0zXabjGTtwSxr9FyqjazSJkmTi%2Bckb01BS5HaGnems%2BZWzdb62qQTfQdwDDl2Wj0RuKnYpX1sDrJljcvHTqow4%2FNn5SBNXYuzPD0Y8agDsRlpr3NIg1vyYGnSS%2BPUURVIcRhC2A0ZyYPxTKqNyuo8IYRlpMSGLYRJDRdOYyEEqEpDIIfY5qYhhLBrL0s%2BLS7imqq995tijYVdCxlx0EMnaW9XlvD93m4aZ0s4cZ3gqspYOjppRKcMcXipGZyU7Ju63iXIhVOKx53trCWqtMpwZzor8n%2BqynBnnlJlNGa5M51VSmlksBSDlOHlKk%2FzUq0KcVVEYgidytz3coS19lPrFh1y2fUP1Xu1HKsRxHWakao9hLNglZHeESaal3vvocKx3zKP7BXnLJtaxgNkjKY1Wp1y7inYUVG7Akg79vSeKefKwHJ1kEtTikBxJrYkmpIBr1TgPdgbrZ1WkPbuz84UEiNZG1ZLhdydE0sqeqlytGG2pEt4%2B0Ccc9H8zs4kS1Br0542F0fqR0lesOCwyehoIioZq86gqcWq6XbZwrTGqMSAhmOhKWVpjp74PObIsLt3R3g0g1oETs8R32woFbLEHUuEs9CiZa6SslZJmpcuf%2F4GcNc0tDf9lYcxvwGVrI3mkDVeY0NjbumOui9XCtkYlZJIbjt3pF8tzQ0czZTvTXnJSdlHSstRXAlPUpQ4vRy1TK4nnNEwaDTd2ZNE6fQSQiieevBiprjXLamjpco5Mv1YSuH%2Fpry4o%2BMPN70cgZI4tYyG7h3J4evzI1tJ%2BIynBLTHMdnlpXQKsTQCkoAaPakZEctL%2BpbK0Y7FMkloCnrXHMsKileMpS0ZR3zvveez2kDJG6szRiSuJqaulfbOaQJ5KfcYH5wnLK82v2uMCmHaPDz%2BDVj%2BfSNNBGdZmIu9v6EIKWbVZHTmVYrl9clSRVsS0urOKDdlW1J%2B6SubFoH3SiF13X8A3uobUgsAG3MAAAAASUVORK5CYII%3D')%20repeat%3B%20outline%3A%20solid%201px%20%23969696%3B%22%3E%3C%2Fdiv%3E"));
...
hasPassback:!1,tagAdTag:d,tagPassback:f}};return e(b)}function I(b,d,f,c,e,p,g,h,k,r,l,y){d.dvregion=0;var v=dv_GetParam(m,"useragent");m=window._dv_win.$dvbs.CommonData;if(void 0!=m.BrowserId&&void 0!=m.BrowserVersion&&void 0!=m.BrowserIdFromUserAgent)var n={ID:m.BrowserId,version:m.BrowserVersion,ID_UA:m.BrowserIdFromUserAgent};else n=T(v?decodeURIComponent(v):navigator.userAgent),m.BrowserId=n.ID,m.BrowserVersion=n.version,m.BrowserIdFromUserAgent=n.ID_UA;var q="";void 0!=d.aUrl&&(q="&aUrl="+d.aUrl);
var A="";try{c.depth=U(c);var w=V(c,f,n);if(w&&w.duration){var u="&dvp_strhd="+w.duration;u+="&dvpx_strhd="+w.duration}w&&w.url||(w=W(c));w&&w.url&&(q="&aUrl="+encodeURIComponent(w.url),A="&aUrlD="+w.depth);var x=c.depth+e;p&&c.depth--}catch(G){u=A=q=x=c.depth=""}a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var t=1;break a}}catch(G){}t=0}e=function(){function b(e){c++;var d=e.parent==e;return e.mraid||d?e.mraid:20>=c&&b(e.parent)}var e=window._dv_win||window,c=0;try{return b(e)}catch(fa){}}();
var m=d.script.src;t="&ctx="+(dv_GetParam(m,"ctx")||"")+"&cmp="+(dv_GetParam(m,"cmp")||"")+"&plc="+(dv_GetParam(m,"plc")||"")+"&sid="+(dv_GetParam(m,"sid")||"")+"&advid="+(dv_GetParam(m,"advid")||"")+"&adsrv="+(dv_GetParam(m,"adsrv")||"")+"&unit="+(dv_GetParam(m,"unit")||"")+"&isdvvid="+(dv_GetParam(m,"isdvvid")||"")+"&uid="+d.uid+"&tagtype="+(dv_GetParam(m,"tagtype")||"")+"&adID="+(dv_GetParam(m,"adID")||"")+"&app="+(dv_GetParam(m,"app")||"")+"&sup="+(dv_GetParam(m,"sup")||"")+"&isovv="+t+"&gmnpo="+
(dv_GetParam(m,"gmnpo")||"")+"&crt="+(dv_GetParam(m,"crt")||"");"1"==dv_GetParam(m,"foie")&&(t+="&foie=1");e&&(t+="&ismraid=1");(e=dv_GetParam(m,"xff"))&&(t+="&xff="+e);(e=dv_GetParam(m,"vssd"))&&(t+="&vssd="+e);(e=dv_GetParam(m,"apifw"))&&(t+="&apifw="+e);(e=dv_GetParam(m,"vstvr"))&&(t+="&vstvr="+e);(e=dv_GetParam(m,"tvcp"))&&(t+="&tvcp="+e);l&&(t+="&urlsrc=sf");y&&(t+="&sfe=1");navigator&&navigator.maxTouchPoints&&5==navigator.maxTouchPoints&&(t+="&touch=1");u&&(t+=u);v&&(t+="&useragent="+v);n&&
(t+="&brid="+n.ID+"&brver="+n.version+"&bridua="+n.ID_UA);t+="&dup="+dv_GetParam(m,"dup");try{t+=dv_AppendIQPAParams(m)}catch(G){}(l=dv_GetParam(m,"turl"))&&(t+="&turl="+l);(l=dv_GetParam(m,"tagformat"))&&(t+="&tagformat="+l);"video"===dv_GetParam(m,"tagtype")&&(t+="&DVP_BYPASS219=1");t+=X();r=r?"&dvf=0":"";l=L("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+d.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+d.callbackName+
"&jsTagObjCallback="+d.tagObjectCallbackName+"&num=6"+t+"&srcurlD="+c.depth+"&ssl="+d.ssl+r+l+"&refD="+x+d.tagIntegrityFlag+d.tagHasPassbackFlag+"&htmlmsging="+(g?"1":"0");(g=dv_GetDynamicParams(m,"dvp").join("&"))&&(c+="&"+g);(g=dv_GetDynamicParams(m,"dvpx").join("&"))&&(c+="&"+g);if(!1===h||k)c=c+("&dvp_isBodyExistOnLoad="+(h?"1":"0"))+("&dvp_isOnHead="+(k?"1":"0"));f="srcurl="+encodeURIComponent(f);(h=Y())&&(f+="&ancChain="+encodeURIComponent(h));h=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&
7>=new Number(RegExp.$1)&&(h=2E3);if(k=dv_GetParam(m,"referrer"))k="&referrer="+k,c.length+k.length<=h&&(c+=k);(k=dv_GetParam(m,"prr"))&&(c+="&prr="+k);(k=dv_GetParam(m,"iframe"))&&(c+="&iframe="+k);(k=dv_GetParam(m,"gdpr"))&&(c+="&gdpr="+k);(k=dv_GetParam(m,"gdpr_consent"))&&(c+="&gdpr_consent="+k);q.length+A.length+c.length<=h&&(c+=A,f+=q);(q=Z())&&(c+="&m1="+q);(q=aa())&&0<q.f&&(c+="&bsig="+q.f,c+="&usig="+q.s);q=ba();0<q&&(c+="&hdsig="+q);navigator&&navigator.hardwareConcurrency&&(c+="&noc="+
navigator.hardwareConcurrency);c+=ca();q=da();c+="&vavbkt="+q.vdcd;c+="&lvvn="+q.vdcv;""!=q.err&&(c+="&dvp_idcerr="+encodeURIComponent(q.err));"prerender"===window._dv_win.document.visibilityState&&(c+="&prndr=1");(m=dv_GetParam(m,"wrapperurl"))&&1E3>=m.length&&c.length+m.length<=h&&(c+="&wrapperurl="+m);c+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(C(f));c=c.length+b.length<=h?c+b:c+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&
window.performance.getEntriesByName&&(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req","dv_create_req_start","dv_create_req_end"),(b=window.performance.getEntriesByName("dv_creqte_req"))&&0<b.length&&(c+="&dvp_exetime="+b[0].duration.toFixed(2)));for(var z in d)d.hasOwnProperty(z)&&void 0!==d[z]&&-1<["number","string"].indexOf(typeof d[z])&&-1===["protocol","callbackName","dvregion"].indexOf(z.toLowerCase())&&!z.match(/^tag[A-Z]/)&&!(new RegExp("(\\?|&)"+z+"=",
"gi")).test(c)&&(c+=["&",z,"=",encodeURIComponent(d[z])].join(""));return{isSev1:!1,url:c}}function X(){var b="";try{var d=window._dv_win.parent;b+="&chro="+(void 0===d.chrome?"0":"1");b+="&hist="+(d.history?d.history.length:"");b+="&winh="+d.innerHeight;b+="&winw="+d.innerWidth;b+="&wouh="+d.outerHeight;b+="&wouw="+d.outerWidth;d.screen&&(b+="&scah="+d.screen.availHeight,b+="&scaw="+d.screen.availWidth)}catch(f){}return b}function da(){var b=[],d=function(b){c(b,null!=b.AZSD,9);c(b,b.location.hostname!=
b.encodeURIComponent(b.location.hostname),10);c(b,null!=b.cascadeWindowInfo,11);c(b,null!=b._rvz,32);c(b,null!=b.FO_DOMAIN,34);c(b,null!=b.va_subid,36);c(b,b._GPL&&b._GPL.baseCDN,40);c(b,f(b,"__twb__")&&f(b,"__twb_cb_"),43);c(b,null!=b.landingUrl&&null!=b.seList&&null!=b.parkingPPCTitleElements&&null!=b.allocation,45);c(b,f(b,"_rvz",function(b){return null!=b.publisher_subid}),46);c(b,null!=b.cacildsFunc&&null!=b.n_storesFromFs,47);c(b,b._pcg&&b._pcg.GN_UniqueId,54);c(b,f(b,"__ad_rns_")&&f(b,"_$_"),
64);c(b,null!=b.APP_LABEL_NAME_FULL_UC,71);c(b,null!=b._priam_adblock,81);c(b,b.supp_ads_host&&b.supp_ads_host_overridden,82);c(b,b.uti_xdmsg_manager&&b.uti_xdmsg_manager.cb,87);c(b,b.LogBundleData&&b.addIframe,91);c(b,b.xAdsXMLHelperId||b.xYKAffSubIdTag,95);c(b,b.__pmetag&&b.__pmetag.uid,98);c(b,b.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(b.supp_ads_host_overridden),100)},f=function(b,c,d){for(var e in b)if(-1<e.indexOf(c)&&(!d||d(b[e])))return!0;return!1},
c=function(c,d,f){d&&-1==b.indexOf(f)&&b.push((c==window.top?-1:1)*f)};try{return function(){for(var b=window,c=0;10>c&&(d(b),b!=window.top);c++)try{b.parent.document&&(b=b.parent)}catch(g){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(e){return{vdcv:28,vdcd:"-999",err:e.message||"unknown"}}}function U(b){for(var d=0;10>d&&b!=window._dv_win.top;)d++,b=b.parent;return d}function V(b,d,f){try{var c;if(!(c=f.ID==$dvbs.Enums.BrowserId.IE)){if(b==window._dv_win.top)var e=$dvbs.Enums.TrafficScenario.OnPage;
else{f=b;try{for(var p=0;window._dv_win.top!=f&&10>=p;){var g=f.parent;if(!g.document)break;f=g;p++}}catch(Q){}e=f==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}c=e!=$dvbs.Enums.TrafficScenario.CrossDomain}if(c)return null;b.performance&&b.performance.mark&&b.performance.mark("dv_str_html_start");if(d){var h=d.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(h&&0<h.length)return null}var k=b.document;if(k&&k.referrer){var r=k.referrer.replace(/\//g,
"\\/").replace(/\./g,"\\."),l=new RegExp('(?:w{0,4}=")?'+r+"[^&\"; %,'\\$\\\\\\|]+","gi");d=/banner|adprefs|safeframe|sandbox|sf\.html/gi;c=/^\w{0,4}="/gi;var y=J(k,"script","src",l,d,c);if(!y){var v=k.referrer;e="";var n=k.getElementsByTagName("script");if(n)for(g=0;!e&&g<n.length;){var q=n[g].innerHTML;if(q&&-1!=q.indexOf(v)){var u=q.match(l);e=K(u,d,c)}g++}(y=e)||(y=J(k,"a","href",l,d,c))}k=htmlUrl=y;a:{if(b.performance&&b.performance.mark&&b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");
b.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var w=b.performance.getEntriesByName("dv_str_html");if(w&&0<w.length){var x=w[0].duration.toFixed(2);break a}}x=null}return{url:k,depth:-1,duration:x}}}catch(Q){}return null}function K(b,d,f){var c="";if(b&&0<b.length)for(var e=0;e<b.length;e++){var p=b[e];p.length>c.length&&null==p.match(d)&&0!=p.indexOf('src="')&&0!=p.indexOf('turl="')&&(c=p.replace(f,""))}return c}function J(b,d,f,c,e,p){b=b.querySelectorAll(d+"["+f+'*="'+
b.referrer+'"]');var g="";if(b)for(d=0;!g&&d<b.length;)g=b[d][f].match(c),g=K(g,e,p),d++;return g}function W(b){try{if(1>=b.depth)return{url:"",depth:""};var d=[];d.push({win:window._dv_win.top,depth:0});for(var f,c=1,e=0;0<c&&100>e;){try{if(e++,f=d.shift(),c--,0<f.win.location.toString().length&&f.win!=b)return 0==f.win.document.referrer.length||0==f.depth?{url:f.win.location,depth:f.depth}:{url:f.win.document.referrer,depth:f.depth-1}}catch(h){}var p=f.win.frames.length;for(var g=0;g<p;g++)d.push({win:f.win.frames[g],
depth:f.depth+1}),c++}return{url:"",depth:""}}catch(h){return{url:"",depth:""}}}function Y(){var b=window._dv_win[C("=@42E:@?")][C("2?46DE@C~C:8:?D")];if(b&&0<b.length){var d=[];d[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var f=0;f<b.length;f++)d[f+1]=b[f];return d.reverse().join(",")}return null}function C(b){new String;var d=new String,f;for(f=0;f<b.length;f++){var c=b.charAt(f);var e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(c);
0<=e&&(c="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((e+47)%94));d+=c}return d}function B(){return Math.floor(1E12*(Math.random()+""))}function T(b){for(var d=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",
...
d.style.textShadow}catch(f){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(f){return 0}}function Z(){try{var b=0,d=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},f=function(b,c){return function(){return b.apply(c,arguments)}},c="svg"===document.documentElement.nodeName.toLowerCase(),e=function(){return"function"!==typeof document.createElement?
document.createElement(arguments[0]):c?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},p=["Moz","O","ms","Webkit"],g=["moz","o","ms","webkit"],h={style:e("modernizr").style},k=function(b,c){function d(){l&&(delete h.style,delete h.modElem)}var f;for(f=["modernizr","tspan","samp"];!h.style&&f.length;){var l=!0;h.modElem=e(f.shift());h.style=h.modElem.style}var g=b.length;for(f=0;f<g;f++){var k=b[f];~(""+k).indexOf("-")&&
(k=cssToDOM(k));if(void 0!==h.style[k])return d(),"pfx"==c?k:!0}d();return!1},r=function(b,c,d){var e=b.charAt(0).toUpperCase()+b.slice(1),l=(b+" "+p.join(e+" ")+e).split(" ");if("string"===typeof c||"undefined"===typeof c)return k(l,c);l=(b+" "+g.join(e+" ")+e).split(" ");for(var h in l)if(l[h]in c){if(!1===d)return l[h];b=c[l[h]];return"function"===typeof b?f(b,d||c):b}return!1};d(0,!0);d(1,r("requestFileSystem",window));d(2,window.CSS?"function"==typeof window.CSS.escape:!1);d(3,r("shapeOutside",
"content-box",!0));return b}catch(l){return 0}}function D(){var b=window,d=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<d++););}catch(f){}return b}function aa(){try{var b=D(),d=0,f=0,c=function(b,c,e){e&&(d+=Math.pow(2,b),f+=Math.pow(2,c))},e=b.document;c(14,0,b.playerInstance&&e.querySelector('script[src*="ads-player.com"]'));c(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=e.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));c(15,2,b.zpz&&
...
try {
	...
	dv_handler152.prototype = dv_baseHandlerIns;
dv_handler152.prototype.constructor = dv_handler152;

    var dv_handlersDefs = [{handler: new dv_handler152(), minRate: 0, maxRate: 90}];
